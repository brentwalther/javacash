...
public class ResultSetMatcher {
  ...
  public ResultSetMatcher(ImmutableList<Field> requiredFields) {
    this.requiredFields = requiredFields;
  }

  public boolean matches(ResultSetMetaData metaData) {
  ...
  public ImmutableMap<String, Integer> getColumnIndicesByName(ResultSetMetaData metaData)
      throws SQLException {
  ...
  public Iterable<ImmutableMap<Field, String>> getResults(ResultSet resultSet) throws SQLException {
